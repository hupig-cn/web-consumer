...
import { ILinkuser, defaultValue } from 'app/shared/model/linkuser.model';
...
export const getlinkusers: ICrudGetAction<ILinkuser> = userid => {
  const requestUrl = `services/basic/api/getlinkusers/${userid}`;
  return {
    type: ACTION_TYPES.FETCH_LINKUSER,
    payload: axios.get<ILinkuser>(requestUrl)
  };
